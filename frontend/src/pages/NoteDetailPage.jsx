...
const NoteDetailPage = () => {
  ...
  const { id } = useParams()//This should be same as it is mentioned in the App.jsx since it is destructuring the id value
  ...
  useEffect(() => {
    const fetchNote = async () => {
      try {
        ...
        console.log("Error in NoteDetailPage function")
        toast.error("Not able to get the notes")
      } finally {
        setLoading(false)
      }
    }
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error("error in the handledelete function", error)
    }
  }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error("error in the handleSave function", error)
    } finally {
      setSaving(false)
    }
